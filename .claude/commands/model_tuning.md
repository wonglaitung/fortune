...
| 原因 | 说明 |
|------|------|
| **避免特征坍缩** | 绝对标签下，美债利率等宏观特征会导致"全涨全跌"，无法选股 |
| **强制学习个股特异性** | 相对标签迫使模型关注"这只票为什么比别的票强" |
| **IC 有意义** | 相对标签的 IC 才是选股能力 |
...
| 原因 | 说明 |
|------|------|
| **目标是择时** | 恒指模型预测的是"大盘会涨还是跌"，不是"跑赢/跑输" |
| **恒指是单一标的** | 没有其他标的可以比较，相对标签无意义 |
| **宏观特征有效** | 恒指受宏观因子主导，绝对标签下宏观特征是有效信号 |
...
*文档版本：v1.2*
*创建日期：2026-04-29*
*更新日期：2026-05-02（强调模型目标：选股必须用相对标签）*
