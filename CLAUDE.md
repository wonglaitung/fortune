...
**个股完整模型**（2026-05-11 验证，12 folds，57只股票）：

| 指标 | 全量特征 (1132) | Top 500 特征 | 评估 |
|------|----------------|--------------|------|
| 平均准确率 | **55.45%** | **55.06%** | ✅ 正常范围（<65% 无数据泄漏） |
| 平均夏普比率 | **5.43** | **5.10** | ✅ 优秀 |
| 平均最大回撤 | **-0.83%** | **-0.79%** | ✅ 优秀 |
| 平均胜率 | 65.55% | 65.15% | 良好 |
| 平均收益率 | +5.37% | +5.18% | ✅ 正收益 |
| 平均 IC | 0.2291 | 0.2247 | ✅ 有效 |
| 平均 Rank IC | 0.2466 | 0.2485 | ✅ 有效 |
| 总体盈亏比 | 1.53 | 1.53 | ✅ 达标 |

**推荐**：使用 Top 500 特征，特征减少 55.8%，性能基本持平
