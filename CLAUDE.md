...
**个股完整模型**（2026-04-29 验证，18 folds，59只股票，770特征，含35个残差特征）：
...
| 平均夏普比率 | 0.8672 | ✅ 接近目标 |
| 平均最大回撤 | -0.27% | ✅ 极佳 |
| IC | -0.0181 | ⚠️ 选股能力有限，启用单调约束/时间衰减修复 |
| 预测分散度 | 0.2393 | ✅ 有区分度 |
...
| 特征数量 | 770 个 | 含 35 个残差特征（2026-04-29 新增） |
| 随机种子 | 42（固定） | 确保可重现性 |
...
**最后更新**：2026-05-02（新增个股选股 vs 恒指择时核心原则）
