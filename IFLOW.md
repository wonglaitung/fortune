...
- **优化效果**：
  - LightGBM一个月模型：标准偏差从±7.17%降至±6.33%（-11.7%）
  - GBDT+LR一个月模型：标准偏差从±7.07%降至±6.06%（-14.3%）
  - 准确率略微下降（<1.4%），换取显著稳定性提升
