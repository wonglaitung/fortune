...
**重要洞察**：
- **高概率信号（>0.75）**：胜率>95%，平均收益率>12%
- **当前阈值0.55**：胜率仅59.70%，平均收益率2.93%
...
2. **高收益月份特征**：
   - 2024-04（11.22%）：准确率93.08%，胜率92.12%
   - 2024-09（16.17%）：准确率90.64%，胜率83.82%
   - 2025-01（16.58%）：准确率83.83%，胜率78.01%

3. **低收益月份特征**：
   - 2025-03（-7.78%）：准确率88.27%，但胜率仅17.01%
   - 2024-05（-0.96%）：准确率72.34%，胜率39.93%
   - 2024-06（-2.33%）：准确率80.16%，胜率35.83%
