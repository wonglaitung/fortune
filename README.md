...
> 2026-09-26 复测；上轮 1d 的 "better (p=0.03)" **未复现**。恒指信号 Long/Flat 1/5/20d 净IR
...
> 基准 = 同向 20d 无条件准确率；**8 模式 Bonferroni 校正后全部不显著**（2026-09-26），**不构成交易信号**。
...
**Walk-forward 验证结果**（38 folds，市场情绪过滤器启用，PIT 口径，**2026-09-26 复测**）：
