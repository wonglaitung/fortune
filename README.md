...
|---------|------|--------|------|---------|--------|
| **Walk-forward**（12 folds，57只股票） | **20天** | **54.49%** | **0.205** | **0.220** | ⭐⭐⭐⭐ 推荐 |
...
**Walk-forward 验证结果（57只股票，12 folds）**：

| 指标 | 数值 | 业界标准 | 评估 |
|------|------|---------|------|
| 综合评分 | **95/100** | - | 优秀 |
| 平均夏普比率 | **4.43** | >1.0 | ✅ 远超标准 |
| 平均最大回撤 | **-0.91%** | <-20% | ✅ 极佳 |
| 平均准确率 | 54.49% | >50% | ✅ |
| 平均 IC | **0.205** | >0.05 | ✅ 优秀 |
| 平均 Rank IC | **0.220** | >0.05 | ✅ 优秀 |
...
| Fold | 测试期间 | 样本数 | 交易次数 | 收益率 | 胜率 | 准确率 | 夏普比率 | 最大回撤 | IC | Rank IC |
|------|---------|-------|---------|-------|------|-------|---------|--------|------|---------|
| 1 | 2025-01 | 1064 | 329 | 12.72% | 78.72% | 47.65% | 6.63 | 0.00% | 0.017 | 0.056 |
| 2 | 2025-02 | 1120 | 397 | 8.04% | 81.11% | 59.55% | 8.31 | 0.00% | 0.265 | 0.313 |
| 3 | 2025-03 | 1176 | 348 | -5.24% | 22.99% | 51.19% | -3.66 | -5.88% | 0.280 | 0.234 |
| 4 | 2025-04 | 1064 | 99 | 11.57% | 98.99% | 38.44% | 9.26 | 0.00% | 0.256 | 0.229 |
| 5 | 2025-05 | 1120 | 497 | 5.03% | 70.82% | 51.70% | 5.27 | -0.15% | 0.072 | 0.121 |
| 6 | 2025-06 | 1176 | 412 | 8.49% | 82.04% | 54.25% | 7.19 | -0.02% | 0.163 | 0.226 |
| 7 | 2025-07 | 1232 | 258 | 3.43% | 62.79% | 43.83% | 3.10 | -0.70% | 0.133 | 0.115 |
| 8 | 2025-08 | 1176 | 467 | 6.67% | 66.60% | 66.33% | 6.82 | 0.00% | 0.332 | 0.390 |
| 9 | 2025-09 | 1232 | 265 | 2.37% | 52.45% | 54.63% | 1.74 | -0.68% | 0.227 | 0.175 |
| 10 | 2025-10 | 1120 | 343 | 2.35% | 56.56% | 52.77% | 1.03 | -2.14% | 0.229 | 0.195 |
| 11 | 2025-11 | 1120 | 347 | -0.37% | 40.63% | 68.39% | -0.68 | -1.33% | 0.374 | 0.365 |
| 12 | 2025-12 | 1176 | 293 | 6.77% | 73.04% | 52.04% | 8.13 | 0.00% | 0.115 | 0.225 |

**关键洞察**：
- ✅ **夏普比率优秀**：平均 4.43，远超业界标准 1.0
- ✅ **最大回撤极低**：平均仅 -0.91%，风险控制优秀
- ✅ **IC 稳定为正**：平均 IC 0.205，Rank IC 0.220
- ⚠️ **Fold 3 和 Fold 11 表现较差**：需关注极端市场环境
- ⚠️ **极端损失风险**：单笔最大损失 -72.96%，必须设置止损
