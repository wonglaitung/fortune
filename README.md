...
- **回测评估功能（2026-02-20）**：
  ...
  - 测试结果：
    ...
    - **融合模型（加权平均）：总收益率108.46%（夏普比率1.63，索提诺比率3.35，最大回撤-11.74%，评级⭐⭐⭐⭐⭐）** ⭐
...
| 一个月（20天） | **60.24%（±6.26%）** | 58.84%（±4.34%） | **61.09%（±1.50%）** ⭐ | **~61-62%（±1.5-2.0%）** ⭐⭐ | **CatBoost 20天和融合模型达到业界顶尖水平** |
...
- ✅ 回测评估功能：验证模型盈利能力，LightGBM夏普比率1.35，GBDT夏普比率2.06，融合模型夏普比率1.63（索提诺比率3.35）
