...
实践人机混合智能的理念，开发具备变现能力的金融资产智能量化分析助手，实时监控加密货币、港股、黄金等金融市场。香港股票方面集成11个数据源、机器学习模型和大模型智能决策。CatBoost 20天模型准确率61.14%，支持实时技术指标、板块轮动分析、综合买卖建议和自动化调度，以智能副驾的方式为投资者提供全面的市场分析和交易策略验证。
...
6. **推荐使用 CatBoost 20天模型**：准确率61.14%，标准差16.61%，F1分数0.6920
...
| 预测周期 | 模型 | 准确率 | F1分数 | 标准差 | 推荐指数 |
|---------|------|--------|--------|--------|----------|
| **20天（推荐）** | **CatBoost** | **61.14%** ⭐ | **0.6920** ⭐ | **16.61%** | ⭐⭐⭐⭐⭐ |
| 20天 | GBDT | 59.99% | 0.7301 | 4.71% | ⭐⭐⭐ |
| 20天 | LightGBM | 58.98% | 0.7179 | 3.87% | ⭐⭐ |
...
**重要提示**：
- ⭐ **推荐使用 CatBoost 20天模型**：准确率61.14%，F1分数0.6920，标准差16.61%
...
|---------|--------|--------|--------|----------|
| **CatBoost 20天** ⭐ | **61.14%** | **0.6920** | **16.61%** | ⭐⭐⭐⭐⭐ |
| LightGBM 20天 | 58.98% | 0.7179 | 3.87% | ⭐⭐ |
| GBDT 20天 | 59.99% | 0.7301 | 4.71% | ⭐⭐⭐ |
