...
| 模式 | 描述 | 20天准确率 | 策略 |
|------|------|-----------|------|
| **101** | 假突破（1天涨5天跌20天涨） | **92.73%** | ⭐ 最优做多，短期回调后中线上涨 |
| 000 | 一致看跌 | 83.58% | 强烈卖出，三周期共振下跌 |
| 111 | 一致看涨 | 81.40% | 强烈买入，三周期共振上涨 |
| 110 | 震荡回调 | 78.57% | 短线冲高后中长线下跌，做空信号 |

**四条交易法则**（恒指增强模型）：

| 法则 | 条件 | 准确率 | 应用场景 |
|------|------|--------|----------|
| **假突破做多** | 1天涨5天跌20天涨(101) | **92.73%** | 短期回调后中线做多 |
| 一致看跌做空 | 三周期全看跌(000) | 83.58% | 趋势确认后减仓或做空 |
| 一致看涨买入 | 三周期全看涨(111) | 81.40% | 趋势确认后顺势加仓 |
...
| 验证方法 | 周期 | 准确率 | 推荐度 |
|---------|------|--------|--------|
| **Walk-forward**（12 folds，59只股票） | **20天** | **54.82%** | ⭐⭐⭐⭐⭐ 推荐 |
