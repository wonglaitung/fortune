...
|---------|------|--------|------|---------|--------|
| **Walk-forward**（12 folds，57只股票） | **20天** | **54.50%** | **0.183** | **0.206** | ⭐⭐⭐⭐ 推荐 |
...
**Walk-forward 验证结果（57只股票，12 folds，Top 500特征，2026-05-17）**：
...
**特征重要性（个股20天模型，Top 10，2026-05-17）**：
