...
4. **推荐使用 CatBoost 20天模型**：准确率61.14%，标准差16.61%，F1分数0.6920
...
# 验证单个板块
python3 ml_services/walk_forward_by_sector.py --sector tech --horizon 20 --use-feature-selection --start-date 2024-01-01 --end-date 2025-12-31 --output-dir output
