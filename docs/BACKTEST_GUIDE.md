...
| 模型 | 平均总收益率 | 平均夏普比率 | 平均最大回撤 | 平均买入信号胜率 | 优秀股票（收益率>50%） | 建议 |
|------|------------|------------|------------|---------|---------------------|------|
...
| **CatBoost 20天买入信号胜率** | **32.81%** | 31.48% | 31.84% | 0.50 |
| **融合模型年化收益率** | **46.29%** | 54.39% | 29.37% | 0.50 |
| **融合模型买入信号胜率** | **31.89%** | 29.20% | 30.97% | 0.50 |
...
1. **CatBoost表现最佳**：
   - ✅ 年化收益率88%左右，买入信号胜率约32%
   - ✅ 在所有置信度下都表现优异

2. **融合模型次之**：
   - ✅ 年化收益率46-54%，买入信号胜率约30%
   - ✅ 置信度0.50时表现最佳
...
| 投资者类型 | 推荐置信度 | 预期收益 | 预期买入信号胜率 | 交易频率 | 适用场景 |
|-----------|-----------|---------|---------|---------|---------|
...
| 模型 | 平均总收益率 | 平均夏普比率 | 平均最大回撤 | 平均买入信号胜率 | 最高收益率 | 最低收益率 | 建议 |
|------|------------|------------|------------|---------|----------|----------|------|
