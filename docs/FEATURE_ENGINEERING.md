...
> **最后更新**：2026-04-30（新增残差特征，更新特征数量为770个）
...
**实现文件**：`ml_services/ml_trading_model.py` 中的特征残差化模块
