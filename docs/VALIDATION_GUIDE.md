...
|------|------|--------|
| 1 | US_10Y_Yield | 5.28 |
| 2 | HSI_Regime_Duration | 3.95 |
| 3 | HSI_Regime_Prob_1 | 2.44 |
| 4 | HSI_Return_20d | 1.85 |
| 5 | Volatility_70pct | 1.75 |
| 6 | MA250_Slope | 1.65 |
| 7 | HSI_Return_60d | 1.59 |
| 8 | SP500_Return_20d | 1.56 |
| 9 | Stock_Cyclical_Score | 1.44 |
| 10 | HSI_Regime_Prob_0 | 1.44 |

**关键发现**：
- ✅ 新增的 HSI 市场状态特征（HSI_Regime_Duration、HSI_Regime_Prob_1/0）进入 Top 10
- ✅ 夏普比率 > 1.0，符合业界标准
- ✅ 最大回撤极低（-0.38%），风险控制优秀
- ⚠️ 稳定性评级低，收益率波动大（标准差 19.14%）
