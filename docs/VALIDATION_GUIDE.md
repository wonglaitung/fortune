...
**特征重要性（Top 10，2026-04-29，含残差特征）**：

| 排名 | 特征 | 重要性 |
|------|------|--------|
| 1 | Volatility_60d | 4.21 |
| 2 | Daily_Median_Return | 3.02 |
| 3 | BB_Width_MA60 | 2.39 |
| 4 | Volatility_70pct | 1.63 |
| 5 | GARCH_Persistence | 1.41 |
| 6 | MA120_Slope | 1.37 |
| 7 | Vol_Mean_20 | 1.30 |
| 8 | Volume_Std_30d | 1.15 |
| 9 | Turnover_Std_20 | 1.12 |
| 10 | OBV | 1.07 |
...
- ⚠️ 稳定性评级低，收益率波动大（标准差 25.70%）

**结论**：
- **模型表现评级**：优秀（80/100）
- **推荐度**：强烈推荐小仓位实盘测试
- **风险提示**：IC 为负值，选股能力有限，建议配合恒指择时判断
