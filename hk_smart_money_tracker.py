...
2. 其次评估市场环境（VIX、成交额变化率、换手率变化率）
3. 然后评估基本面质量（PE、PB、ROE、估值）
4. 接着分析技术面（多周期趋势、相对强度、技术指标）
5. 再识别建仓/出货信号
6. 最后综合评分进行决策
...
2. **买入建议优先级**：综合评分>50分 且 建仓评分 ≥ 出货评分
3. **卖出建议优先级**：出货评分 ≥ 3.0 且 出货评分 > 建仓评分
4. **持有建议优先级**：综合评分30-50分，或建仓评分与出货评分差距<1.0分
...
- 目标价格：XX港元（如适用）
- 风险等级：X级
- 风险因素：详细说明，解释为什么出货评分 > 建仓评分

📊 持有建议（综合评分30-50分，或建仓评分与出货评分差距<1.0分）

股票代码 股票名称
- 持有理由：详细说明，解释为什么建仓评分与出货评分差距<1.0分（信号模糊，建议观望）
- 建议仓位：XX%
- 风险等级：X级
...
🎯 投资策略建议
基于当前市场信号和综合评分分析，为不同风险偏好的投资者提供针对性策略：
- **激进型投资者**：重点布局高综合评分股票，把握超跌反弹与趋势加速机会，关注技术指标协同性强的股票
- **稳健型投资者**：优先配置基本面评分高、多周期趋势稳定的股票，追求"低估值+高分红+趋势稳"组合
- **保守型投资者**：观望为主，关注防御性强的股票（如银行股、公用事业股）的防御价值，等待更明确的信号

### 🔮 后市展望
基于当前市场信号和综合评分分析，展望短期市场走势：
