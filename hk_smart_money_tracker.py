...
1. 🎯 综合推荐（3-5只，按综合评分排序）
   ...
   - 新闻影响评估：新闻情绪（正面/负面/中性）、影响程度（重大/中等/轻微）、新闻加分/扣分（±XX%）
   - 推荐理由：基于综合评分的详细分析
...
2. ⚠️ 风险警示（按风险等级排序）
   ...
   - 🟠 中高风险（出货评分≥5.0，strong级别）：股票代码及名称，出货评分，应对建议（卖出60-100%）
   - 🟠 中风险（出货评分3.0-5.0，weak级别）：股票代码及名称，出货评分，应对建议（卖出30-60%）
   - 🟡 低风险（技术面恶化或基本面差）：股票代码及名称，风险来源，应对建议（观望或减仓）
