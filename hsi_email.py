    ...
    def generate_report_content(self, target_date, hsi_data, hsi_indicators, stock_results):
        ...
        <div class="section">
            ...
            <ul>
              ...
              <li><b>风险评估</b>：基于ES与历史最大回撤的比值进行的风险等级评估：
                <ul>
                  <li><b>优秀</b>：ES < 最大回撤/3，当前风险控制在历史波动范围内</li>
                  <li><b>合理</b>：回撤/3 ≤ ES ≤ 回撤/2，风险水平适中，符合历史表现</li>
                  <li><b>警示</b>：ES > 最大回撤/2，当前风险水平超过历史波动，需要谨慎</li>
        ...
        text += "• 风险评估：基于ES与历史最大回撤的比值进行的风险等级评估：\n"
        text += "  - 优秀：ES < 最大回撤/3，当前风险控制在历史波动范围内\n"
        text += "  - 合理：回撤/3 ≤ ES ≤ 回撤/2，风险水平适中，符合历史表现\n"
        text += "  - 警示：ES > 最大回撤/2，当前风险水平超过历史波动，需要谨慎\n"
