...
**尝试方案**：对 FP 错误施加 2.5 倍惩罚（`class_weights={0: 2.5, 1: 1.0}`）

**测试结果**：

| 指标 | 无惩罚 | fp_penalty=2.5 | 变化 |
|------|--------|----------------|------|
| 总预测涨次数 | 7262 | 5840 | -19.6% |
| 总 FP 次数 | 2646 | 2217 | -16.2% |
| 总 FP 率 | 36.4% | 38.0% | +1.5% |
...
**结论**：
- FP 减少比例 (16.2%) < 预测涨减少比例 (19.6%)
- 非对称损失函数使模型更保守，但 FP 率反而上升
- 问题 Fold 盈亏比无改善
